...
====================================-->
		...
		<!-- Start Flurry Attack Table 
				...
				<fo:table-row>
					...
					<fo:table-cell number-rows-spanned="2">
						...
						<xsl:if test="monk_flurry &gt; 0">
							<fo:block font-weight="bold" font-size="9pt">Flurry of Blows</fo:block>
						</xsl:if>
						<xsl:if test="brawler_flurry &gt; 0">
							<fo:block font-weight="bold" font-size="9pt">Brawler's Flurry</fo:block>
						</xsl:if>
					</fo:table-cell>
	...
	<xsl:template match="weapons/unarmedRage">
		<!-- START Unarmed Attack Table -->
		<!--<xsl:choose>
			<xsl:when test="(weapons/naturalattack) &lt; 1">	-->
		<fo:table table-layout="fixed" width="100%" space-before="2mm">
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell number-rows-spanned="2">
						...
						<fo:block font-weight="bold" font-size="9pt">UNARMED RAGE</fo:block>
					</fo:table-cell>
					<fo:table-cell>
						<xsl:call-template name="attrib">
							<xsl:with-param name="attribute" select="'weapon.title'"/>
	...
	<xsl:template match="weapons/unarmedPowerAttack">
		<!-- START Unarmed Attack Table -->
		<!--<xsl:choose>
			<xsl:when test="(weapons/naturalattack) &lt; 1">	-->
		<fo:table table-layout="fixed" width="100%" space-before="2mm">
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell number-rows-spanned="2">
						...
						<fo:block font-weight="bold" font-size="9pt">UNARMED POWER ATTACK</fo:block>
					</fo:table-cell>
					<fo:table-cell>
						<xsl:call-template name="attrib">
							<xsl:with-param name="attribute" select="'weapon.title'"/>
	...
	<xsl:template match="weapons/unarmedPowerAttackRage">
		<!-- START Unarmed Attack Table -->
		<!--<xsl:choose>
			<xsl:when test="(weapons/naturalattack) &lt; 1">	-->
		<fo:table table-layout="fixed" width="100%" space-before="2mm">
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell number-rows-spanned="2">
						...
						<fo:block font-weight="bold" font-size="9pt">UNARMED POWER ATTACK RAGE</fo:block>
					</fo:table-cell>
					<fo:table-cell>
						<xsl:call-template name="attrib">
							<xsl:with-param name="attribute" select="'weapon.title'"/>
