...
<!-- Blocks to put together PC Sheet -->
	...
	<xsl:import href="common_sheet/block_weapons_custom.xslt"/>
<!-- END -->
							...
							<fo:table-body>
								...
								<fo:table-row>
									<fo:table-cell number-columns-spanned="2">
										...
										<xsl:apply-templates select="weapons/unarmedRage"/>
										<xsl:apply-templates select="weapons/unarmedPowerAttack"/>
										<xsl:apply-templates select="weapons/unarmedPowerAttackRage"/>
