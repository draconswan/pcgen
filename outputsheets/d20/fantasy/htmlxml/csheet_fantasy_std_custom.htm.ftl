...
<!-- START Unarmed Attack Table -->
   ...
   <#if (pcvar("RageLvl") >= 1)>
   <#assign rageBonus = pcvar('VAR.RageBonus')>
    <tr>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>UNARMED (Rage)</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>REACH</b></font></td>
    ...
    <tr>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#list pcstring('WEAPONH.TOTALHIT')?split("/") as bab><#assign ab = rageBonus + bab?number><#if (ab >= 0)>+</#if>${ab}<#if (pcstring('WEAPONH.NUMATTACKS')?number > bab?counter)>/</#if></#list>
		<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}+${bonusDamage+rageBonus}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
   </#if>
   <#if (pcstring("ABILITYALLLIST.FEAT")?contains("Power Attack"))>
   <#assign powerAttackAttackModifier = pcvar('VAR.PowerAttackModifier')>
   <#assign powerAttackDamageModifier = pcvar('VAR.PowerAttackDamageModifier')>
    <tr>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>UNARMED (Power Attack)</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>REACH</b></font></td>
    ...
    <tr>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#list pcstring('WEAPONH.TOTALHIT')?split("/") as bab><#assign ab = bab?number - powerAttackAttackModifier><#if (ab >= 0)>+</#if>${ab}<#if (pcstring('WEAPONH.NUMATTACKS')?number > bab?counter)>/</#if></#list>
		<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}+${bonusDamage+powerAttackDamageModifier}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
   </#if>
   <#if (pcstring("ABILITYALLLIST.FEAT")?contains("Power Attack")) && (pcvar("RageLvl") >= 1)>
   <#assign powerAttackAttackModifier = pcvar('VAR.PowerAttackModifier')>
   <#assign powerAttackDamageModifier = pcvar('VAR.PowerAttackDamageModifier')>
    <tr>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>UNARMED (Power Attack, Rage)</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
     <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>REACH</b></font></td>
    ...
    <tr>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#list pcstring('WEAPONH.TOTALHIT')?split("/") as bab><#assign ab = rageBonus + bab?number - powerAttackAttackModifier><#if (ab >= 0)>+</#if>${ab}<#if (pcstring('WEAPONH.NUMATTACKS')?number > bab?counter)>/</#if></#list>
		<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}+${bonusDamage+powerAttackDamageModifier+rageBonus}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
   </#if>
...
<!-- START Flurry Attack Table -->
   <table cellpadding="0" cellspacing="0" border="0" width="100%" summary="Flurry Attack">
    <tr>
	 ...
	 <#if (pcvar("classlevel(\"Brawler\")") >= 1)>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Brawler's Flurry</b></font></td>
	 </#if>
     <td align="center" bgcolor="black" width="20%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
	 <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="13%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
	...
	<#if (pcvar('VAR.RageBonus.INTVAL') > 0)>
	<#assign fab_1 = pcvar('VAR.FAB_1.INTVAL') + fab + rageBonus>
	<#assign fab_2 = pcvar('VAR.FAB_2.INTVAL') + fab + rageBonus>
	<#assign fab_3 = pcvar('VAR.FAB_3.INTVAL') + fab + rageBonus>
	<#assign fab_4 = pcvar('VAR.FAB_4.INTVAL') + fab + rageBonus>
	<#assign fab_5 = pcvar('VAR.FAB_5.INTVAL') + fab + rageBonus>
	<#assign fab_6 = pcvar('VAR.FAB_6.INTVAL') + fab + rageBonus>
	<#assign fab_7 = pcvar('VAR.FAB_7.INTVAL') + fab + rageBonus>
	<#assign fab_8 = pcvar('VAR.FAB_8.INTVAL') + fab + rageBonus>
	<#assign fab_9 = pcvar('VAR.FAB_9.INTVAL') + fab + rageBonus>
	<tr>
     <#if (pcvar("classlevel(\"Monk\")") >= 1)>
	 <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Flurry of Blows (Rage)</b></font></td>
	 </#if>
	 <#if (pcvar("classlevel(\"Brawler\")") >= 1)>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Brawler's Flurry (Rage)</b></font></td>
	 </#if>
     <td align="center" bgcolor="black" width="20%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
	 <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="13%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
    ...
    <tr>
	 ...
	 <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}<#if (bonusDamage+rageBonus >= 0)>+</#if>${bonusDamage+rageBonus}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
	</#if>
	...
	<#assign powerAttackAttackModifier = pcvar('VAR.PowerAttackModifier')>
	<#assign powerAttackDamageModifier = pcvar('VAR.PowerAttackDamageModifier')>
	<#assign fab_1 = pcvar('VAR.FAB_1.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_2 = pcvar('VAR.FAB_2.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_3 = pcvar('VAR.FAB_3.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_4 = pcvar('VAR.FAB_4.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_5 = pcvar('VAR.FAB_5.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_6 = pcvar('VAR.FAB_6.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_7 = pcvar('VAR.FAB_7.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_8 = pcvar('VAR.FAB_8.INTVAL') + fab - powerAttackAttackModifier>
	<#assign fab_9 = pcvar('VAR.FAB_9.INTVAL') + fab - powerAttackAttackModifier>
	<tr>
     <#if (pcvar("classlevel(\"Monk\")") >= 1)>
	 <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Flurry of Blows (Power Attack)</b></font></td>
	 </#if>
	 <#if (pcvar("classlevel(\"Brawler\")") >= 1)>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Brawler's Flurry (Power Attack)</b></font></td>
	 </#if>
     <td align="center" bgcolor="black" width="20%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
	 <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="13%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
    ...
    <tr>
	 ...
	 <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}<#if (bonusDamage+powerAttackDamageModifier >= 0)>+</#if>${bonusDamage+powerAttackDamageModifier}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
	</#if>
	<#if (pcstring("ABILITYALLLIST.FEAT")?contains("Power Attack")) && (pcvar('VAR.RageBonus.INTVAL') > 0)>
	<#assign rageBonus = pcvar('VAR.RageBonus.INTVAL')>
	<#assign powerAttackAttackModifier = pcvar('VAR.PowerAttackModifier')>
	<#assign powerAttackDamageModifier = pcvar('VAR.PowerAttackDamageModifier')>
	<#assign fab_1 = pcvar('VAR.FAB_1.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_2 = pcvar('VAR.FAB_2.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_3 = pcvar('VAR.FAB_3.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_4 = pcvar('VAR.FAB_4.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_5 = pcvar('VAR.FAB_5.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_6 = pcvar('VAR.FAB_6.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_7 = pcvar('VAR.FAB_7.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_8 = pcvar('VAR.FAB_8.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<#assign fab_9 = pcvar('VAR.FAB_9.INTVAL') + fab + rageBonus - powerAttackAttackModifier>
	<tr>
     <#if (pcvar("classlevel(\"Monk\")") >= 1)>
	 <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Flurry of Blows (Power Attack, Rage)</b></font></td>
	 </#if>
	 <#if (pcvar("classlevel(\"Brawler\")") >= 1)>
     <td align="center" height="25" bgcolor="black" rowspan="2" width="40%"><font style="font-size:10pt" color="white"><b>Brawler's Flurry (Power Attack, Rage)</b></font></td>
	 </#if>
     <td align="center" bgcolor="black" width="20%" height="15"><font style="font-size:6pt" color="white"><b>TOTAL ATTACK BONUS</b></font></td>
	 <td align="center" bgcolor="black" width="15%" height="15"><font style="font-size:6pt" color="white"><b>DAMAGE</b></font></td>
     <td align="center" bgcolor="black" width="13%" height="15"><font style="font-size:6pt" color="white"><b>CRITICAL</b></font></td>
    ...
    <tr>
	 ...
	 <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>
		<#assign baseDamage = pcstring('WEAPONH.BASEDAMAGE')>
		<#assign bonusDamage = pcstring('WEAPONH.BONUSDAMAGE')?number>
		${baseDamage}<#if (bonusDamage+rageBonus+powerAttackAttackModifier >= 0)>+</#if>${bonusDamage+rageBonus+powerAttackDamageModifier}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('WEAPONH.CRIT')}/x${pcstring('WEAPONH.MULT')}<br /></b></font></td>
     <td align="center" bgcolor="white" class="border"><font style="font-size:8pt" color="black"><b>${pcstring('REACH')}<br /></b></font></td>
    </tr>
	</#if>
